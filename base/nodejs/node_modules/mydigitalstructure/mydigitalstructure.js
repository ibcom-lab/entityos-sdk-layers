...
module.exports = 
{
	...
	init: function (callBack, settings)
			{
				...
				{	
					...
					fs.readFile('settings-private.json', function (err, buffer)
					{
						console.log('fs' + err)
						if (!err)
						{	
	...
	send: function (options, data, callBack, callBackOptions)
			{
				var https = require('https');
				...
				var req = https.request(requestOptions, function(res)
				{
					...
					{	
				    	...
				    	{
				    		if (_.isUndefined(callBackOptions)) {callBackOptions = options}
				    		callBack(callBackOptions, data)
				    	};
					});
				});
				...
				req.on('error', function(error)
				{
					module.exports._util.testing.message(error.message, 'mydigitalstructure.send.response.error');
				  	...
				  	{
				  		if (_.isUndefined(callBackOptions)) {callBackOptions = options}
				  		callBack(callBackOptions, data, error)
				  	};
				});
	...
	_util: 
			{
				session: function () {return module.exports.data.session},
